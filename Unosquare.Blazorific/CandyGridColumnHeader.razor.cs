...
/// <summary>
/// Represents a column header within a <see cref="CandyGridColumn"/>.
/// </summary>
...
public sealed partial class CandyGridColumnHeader
{
    ...
    private bool HasFilterOptions => Column?.FilterOptionsProvider is not null && FilterOptions is not null && FilterOptions.Count > 0;
    ...
    private void CoerceFilterState()
    {
        ...
        FilterVal2 = Column?.FilterArgument is not null && Column?.FilterArgument.Length > 0
